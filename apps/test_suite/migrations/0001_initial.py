# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-07-27 14:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatePerson', models.CharField(default='', help_text='Last Update User', max_length=50, verbose_name='Last Update User')),
                ('updateTime', models.DateTimeField(default=None, help_text='Last Update Date', verbose_name='Last Update Date')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='TestSuite',
            fields=[
                ('name', models.CharField(help_text='Test Suite Name', max_length=255, primary_key=True, serialize=False, verbose_name='Test Suite Name')),
                ('application', models.CharField(choices=[('Web', 'Web'), ('Mobile', 'Mobile'), ('API', 'API'), ('Siebel', 'Siebel'), ('C/S', 'Client/Server')], max_length=20)),
                ('framework', models.CharField(choices=[('Selenium', 'Selenium'), ('Cucumber', 'Cucumber'), ('UFT', 'UFT')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('startTime', models.DateTimeField(default=None, help_text='Start Time', verbose_name='Start Time')),
                ('endTime', models.DateTimeField(default=None, help_text='End Time', verbose_name='End Time')),
                ('created_time', models.DateTimeField(default=datetime.datetime.now, help_text='Created Time', verbose_name='Created Time')),
                ('project', models.ForeignKey(help_text='Project Name', on_delete=django.db.models.deletion.CASCADE, to='projects_manage.Projects', verbose_name='Project Name')),
